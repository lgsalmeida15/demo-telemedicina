...
<head>
    ...
    <title>Área do Beneficiário - Login</title>
    ...
    <style>
        ...
        /* A imagem agora preenche todo o painel corretamente */
        ...
        @media (max-width: 991px) {
            ...
            /* Some completamente o painel da esquerda */
            .left-panel {
                display: none !important;
                visibility: hidden !important;
            }

            /* Painel direito ocupa 100% */
            .right-panel {
                width: 100% !important;
            ...
            /* Card centralizado e mais confortável */
            .login-card {
                width: 100% !important;
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <div class="left-panel">
            ...
            <div class="left-text">
                Bem-vindo<br>
                à Área do Beneficiário
            </div>

            <!-- Imagem que você irá colocar depois -->
        ...
        <div class="right-panel">
            ...
            <div class="login-card">
                ...
                <h3>Área do <span style="color: #152651">Beneficiário</span></h3>
                ...
                <form method="POST" action="{{ route('beneficiary.login.submit') }}">
                    @csrf
                    ...
                    <a href="{{ route('forgot.form.beneficiary.password') }}">Esqueci minha senha</a>
                    ...
                    <div style="width: 100%; text-align: center; margin-top:1rem">
                        <a href="{{ route('dependent.login') }}">Acesso do Dependente</a>
                    </div>
                </form>
