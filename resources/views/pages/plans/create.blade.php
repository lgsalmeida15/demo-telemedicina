                    ...
                    <div class="card-body">
                        <form action="{{route('plan.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="is_telemedicine" id="is_telemedicine" value="0">
                                        <button type="button" id="telemedicineToggle" class="toggle-btn off">
                                            NÃO
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="btn-flutante d-flex justify-content-between gap-3">
                                ...
                                <a href="{{route('plan.index',['company'=>$company->id])}}" class="btn btn-secondary btn-lg w-50">VOLTAR</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const toggleBtn = document.getElementById('telemedicineToggle');
        const hiddenInput = document.getElementById('is_telemedicine');
