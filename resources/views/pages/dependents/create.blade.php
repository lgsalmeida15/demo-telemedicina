            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">Cadastrar Novo Dependente de {{ $beneficiary->name }}</h4>
                    ...
                    <div class="card-body">
                        <form action="{{route('dependent.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        placeholder="Senha de acesso a área do dependente" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="gender" id="gender_select" class="form-control" required>
                            ...
                            <div class="btn-flutante d-flex justify-content-between gap-3">
                                ...
                                @else
                                <a href="{{ route('dependent.index',['beneficiaryId'=>$beneficiary->id]) }}" class="btn btn-secondary btn-lg w-50">VOLTAR</a>
                                @endif
                            </div>
                        </form>
                    </div>
