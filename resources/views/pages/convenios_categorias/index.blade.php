@extends('layouts.app', ['activePage' => 'convenios_categoria', 'titlePage' => __('Categorias')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Categorias de Serviços</h4>
                        </div>
                        <div class="card-body">
                            <div class="table">
                                {{-- Botão de Registro --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button
                                                            ...
                                                            data-action="{{route('convenio.categoria.softdelete', ['categoria'=>$categoria->id])}}">
                                                            Excluir
                                                        </button>
                                                    </td>
                                                </tr>
            ...
            @include('pages.convenios_categorias.modals')
