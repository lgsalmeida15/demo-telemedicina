            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">Atualizar Empresa: {{ $company->name }}</h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('company.update', ['company' => $company->id]) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cnpj" id="cnpj" class="form-control" value="{{ old('cnpj', $company->cnpj) }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="uf" id="uf" class="form-control" value="{{ old('uf', $company->uf) }}" required
                                        placeholder="Ex: PA">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="billing_date" id="billing_date" class="form-control" value="{{ old('billing_date', $company->billing_date) }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <h5 class="bmd-label-floating">Dia de Vencimento * todo dia:</h5>
                                        <input type="number" min="1" name="due_day" id="due_day" class="form-control" value="{{ old('due_day', $company->due_day) }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="btn-flutante d-flex justify-content-between gap-3">
                                <button type="submit" class="btn btn-primary btn-lg w-50">ATUALIZAR EMPRESA</button>
